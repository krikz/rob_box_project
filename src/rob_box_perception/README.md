...
**Проблема**: Большие файлы (800+ LOC) с смешанными обязанностями затрудняют работу с AI
...
- [План рефакторинга Perception](../../docs/development/REFACTORING_PLAN_PERCEPTION.md) - Детальный план
- [Quick Reference для AI](../../docs/development/VIBE_CODING_QUICK_REF.md) - Быстрый справочник

**Целевая структура**:
```
rob_box_perception/
├── core/          # Бизнес-логика (детекция событий, контекст)
├── llm/           # LLM интеграция (рефлексия)
