    ...
    def _build_dj_prompt(self, n: int) -> str:
        ...
        if n == 1:
            ...
            return (
                ...
                "0) Сначала вызови list_tracks() БЕЗ параметров — получишь весь список. "
                "   Прочитай названия и теги, найди 3-5 треков подходящих по теме — используй их как вдохновение! "
