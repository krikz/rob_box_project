    ...
    def _build_dj_prompt(self, n: int) -> str:
        ...
        if n == 1:
            ...
            return (
                ...
                "   Если артист не упомянут явно — ВЫЗОВИ search_artist_style для DJ-образа/концепта! "
                "   Пример: Пастырь культа → search_artist_style('ритуальная музыка хоралы культ'). "
                "   Робот-диджей → search_artist_style('робот электронная музыка'). "
                "   Ведьма → search_artist_style('ведьмы оккультная музыка doom'). "
                "   Ищи ассоциации: образ → стили, инструменты, настроение. "
