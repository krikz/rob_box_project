...
export type JsonEvent =
  ...
  | { type: "voice_list"; voices: VoiceInfo[]; active_provider?: string; active_voice?: string; ts_ms: number }
  | { type: "voice_set_ack"; voice_id: string; preset: VoicePreset; ts_ms: number }
  | { type: "voice_set_nack"; voice_id?: string; reason: string; available?: string[]; ts_ms: number }
  | {
