...
TOOL_CATALOG_DATA: tuple[dict[str, Any], ...] = (   {   'llm_visible': True,
        ...
        'parameters': {   'type': 'object',
                          'properties': {   'name': {   'type': 'string',
                                                        'description': 'Название '
                                                                       ...
                                                                       'оверрайд '
                                                                       'темпа). '
                                                                       'lead_notes/lead_dur/bass_notes/pad_notes/progression/perc '
                                                                       'указывать не '
                                                                       'нужно и не '
                                                                       'импровизируй '
                                                                       'ноты по памяти '
                                            ...
                                            'seed': {   'type': 'integer',
                                                        'description': 'Ручка (только '
                                                                       ...
                                                                       'аранжировки. '
                                                                       'Ручки '
                                                                       'bass_style/pad_style/drum_style, '
                                                                       'оставленные на '
                                                                       'auto, при '
                                                                       'заданном seed '
                                                                       'выбирают '
    ...
    {   'llm_visible': True,
        ...
        'description': 'Показать партитуру аранжировки БЕЗ проигрывания — те же '
                       'параметры, что у compose_music '
                       '(name/root/scale/форма/тембры/ручки key_detection, chords, '
                       'harmonic_rhythm, density, bass_style, bass_approach, '
                       'pad_style, pad_register, counter, theme_octaves, lead_octave, '
                       'lead_outliers, levels и т.д.). Строит гармонию, спецификацию и '
                       'код ТОЧНО как compose_music, но ничего не звучит и состояние '
                       "музыки не меняется — только текст партитуры в data['score']. "
                       'Используй ПЕРЕД повторной игрой, когда юзер просит подстроить '
                       'звучание («бас гудит», «сделай прозрачнее») — максимум один '
                       'раз, затем сразу compose_music с исправленными ручками. НЕ '
