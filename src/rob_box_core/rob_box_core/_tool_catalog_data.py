...
TOOL_CATALOG_DATA: tuple[dict[str, Any], ...] = (   {   'llm_visible': True,
    ...
    {   'llm_visible': True,
        ...
        'description': 'Найти известную мелодию по имени и вернуть её ТОЧНЫЕ ноты '
                       "сырой RTTTL-строкой в data['rtttl'], НИЧЕГО не играя. Нужен "
                       'только когда нужны сами ноты/метаданные. Чтобы СЫГРАТЬ мелодию '
                       'по имени — вызови compose_music(name=..., variants=[...]): он '
                       'сам найдёт ноты, разберёт RTTTL и построит аранжировку вокруг '
                       'темы. НЕ разбирай RTTTL вручную и НЕ зови execute_music_code с '
