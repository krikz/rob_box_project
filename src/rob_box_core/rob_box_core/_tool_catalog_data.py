...
TOOL_CATALOG_DATA: tuple[dict[str, Any], ...] = (   {   'llm_visible': True,
                          ...
                          'properties': {   'name': {   'type': 'string',
                                            ...
                                            'counter_synth': {   'type': 'string',
                                                                 ...
                                                                 'enum': [   'imperialbrass',
                                                                             ...
                                                                             'blip',
                                                                             'arpy']},
                                            'theme_octaves': {   'type': 'boolean',
                                                                 'description': 'Удвоение '
                                                                                'темы '
                                                                                'октавой '
                                                                                'вниз '
                                                                                '— '
    ...
    {   'llm_visible': True,
        ...
        'description': 'Что робот сейчас видит камерой и чувствует: лица и объекты в '
                       'кадре (детекции с уверенностью), а также время суток, заряд '
                       'батареи, температура, движение, здоровье системы, режим '
                       'картографирования, сводка недавних событий. Вызывай на «что ты '
                       'видишь», «кто перед тобой», «видишь меня».',
        'parameters': {   'type': 'object',
                          'properties': {},
                          'required': [],
                          'additionalProperties': False},
