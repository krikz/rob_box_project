...
# Добивка — символом "-" (пауза без ретригера сэмпла, см.
# ``_prewarm_sample_buffers`` в tools/music.py), а не новым ударом: лишние
# шаги должны молчать, а не менять рисунок, который написала модель.
