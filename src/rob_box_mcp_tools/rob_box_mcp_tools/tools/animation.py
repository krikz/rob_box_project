...
class PlayAnimationTool(MCPTool):
    ...
    def description(self) -> str:
        return (
            ...
            "Используй параллельно с речью для эмоций (happy, sad, angry, surprised, thinking, victory) "
            "и спецэффектов (police_lights, fire_truck, turn_left, turn_right). "
            "Когда показываешь по запросу — скажи 'Показываю анимацию X', не описывай детали."
        )
