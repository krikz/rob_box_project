...
**Вывод:** `mbentley/apt-cacher-ng` лучше подходит для нашего use case благодаря:
...
| Последующие | 15-20 мин | 5-8 мин | **2-3x** |
| Сетевой трафик | ~500MB | ~50MB | **90%** |
