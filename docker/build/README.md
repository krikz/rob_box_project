...
services:
  oak-d:
    ...
    image: 10.1.1.5:5000/krikz/rob_box:oak-d-lyrical-latest
    ...
    steps:
      ...
      - name: Push to local registry
        run: |
          ...
          docker tag ghcr.io/krikz/rob_box:rtabmap-lyrical-latest \
                     ${{ secrets.BUILD_MACHINE_IP }}:5000/krikz/rob_box:rtabmap-lyrical-latest
          docker push ${{ secrets.BUILD_MACHINE_IP }}:5000/krikz/rob_box:rtabmap-lyrical-latest
```
