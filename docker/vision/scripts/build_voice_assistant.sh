...
# Параметры
IMAGE_NAME_LOCAL="rob_box:voice-assistant-kilted-test"
IMAGE_NAME_PROD="ghcr.io/krikz/rob_box:voice-assistant-kilted-latest"
...
echo "Base image: ghcr.io/krikz/rob_box:voice-base-kilted-latest"
echo ""

docker build \
    --platform linux/arm64 \
    -t "$IMAGE_NAME_LOCAL" \
    --build-arg BASE_IMAGE=ghcr.io/krikz/rob_box:voice-base-kilted-latest \
    -f "$DOCKERFILE" \
    "$CONTEXT"
