...
#### 🔮 Док-станция (Charging station)
- **Автоматический возврат** на док-станцию при низком заряде
- **Визуальная локализация** док-станции (AprilTag или IR markers)
- **Точное позиционирование** для подключения контактов
- **Battery monitoring:** автоматическая зарядка

**Технологии:** AprilTag, IR sensors, BMS integration  
**Hardware:** Док-станция с контактами зарядки (~$200-300)  
**Приоритет:** 🟡 Средний
