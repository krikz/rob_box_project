...
7. **zram-своп** (Vision Pi) - сжатый своп в RAM, чтобы узел под нагрузкой
   тормозил, а не уходил в недоступность ([#2621](https://github.com/krikz/rob_box_project/issues/2621))
