...
* Issue: #2132 (kanban t_2e1feeb1)
* Title: bug(operator P0): все операторские инструменты режутся срезом — llm_adapter подписывает запросы ТАРС как sender=dialogue_node
* Created: 2026-09-08T06:35:33Z by agent-flow-triage
