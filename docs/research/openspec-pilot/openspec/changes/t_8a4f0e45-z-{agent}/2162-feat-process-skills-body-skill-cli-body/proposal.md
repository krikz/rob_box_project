...
* Issue: #2162 (kanban t_8a4f0e45)
* Title: feat(process): явное указание skills в body карточки (а не через --skill CLI) — воркер парсит body и вызывает скилы сам
* Created: 2026-09-08T14:30:51Z by agent-flow-triage
