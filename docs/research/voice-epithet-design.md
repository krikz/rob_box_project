...
- `src/rob_box_voice/rob_box_voice/dialogue_node.py:751` —
  `speaker_db_path = /data/speakers.db`.
- `src/rob_box_mcp_tools/.../tools/dialogue.py:911-998` — известный баг
  «`name='Зовут'`» при ловушке фразы «робот меня зовут Денис говорю».
