...
**Скорее всего используется:** Zenoh 0.10.x или 0.11.x (из пакета ROS 2 Humble)
...
**Проблема:**
- НЕ совместимо с текущим rmw_zenoh_cpp для Humble
...
Поскольку мы используем **Zenoh 0.10.x/0.11.x** через ROS 2 Humble, мы НЕ можем обновиться до 1.0. 
...
2. **Решена в Zenoh 1.0**, но недоступна для Humble
