...
| Родительские ADR | [ADR-0004 §2.1–2.4](../adr/0004-minimax-tts-integration-design.md) (port, registry, retry, CB), [ADR-0007](../adr/0007-minimax-tts-integration-final.md) §2.2 (итоговая архитектура), [ADR-0003](../adr/0003-minimax-tts-architecture.md) (текущая реализация MiniMax), [ADR-0008](../adr/0008-tts-provider-extension-points-landed.md) (landed implementation) |
