...
| Родители | ADR-0014 (контракт close=e2e-done ∧ MERGED), ADR-0018 (raw-evidence обязателен), ADR-AF-0026 (recovery contract), ADR-0046 (orphan-cleanup-after-merge — kanban-карточки, не issue), ADR-0049 (ночной ревью как жанр). |
