# ADR-0108 — MiniMax STT: различать «пустой текст» и «нет поля text»

> Ранее фигурировал как ADR-0096 в коммите `1ada7ed9` (PR #2537). Перенумерация 2026-09-15: см. issue #2582 — сосед `0096-encounter-seam.md` влит раньше (`984542ab`, PR #2454) и остался на 0096.
