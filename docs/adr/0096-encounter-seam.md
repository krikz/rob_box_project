...
| ADR-number | 0096 (collision-fix, 2026-09-15: см. issue #2582 — соседи `0096-minimax-stt-empty-text-semantics.md` и `0096-vision-hailo-launch-file-decoupling.md` получили тот же номер и переехали в ADR-0108 и ADR-0110 соответственно; этот ADR первый по merge-time, коммит `984542ab` (PR #2454)) |
