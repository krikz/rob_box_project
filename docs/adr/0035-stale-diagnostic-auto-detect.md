...
| Родители | ADR-0018 (честность — auto-block лучше молчаливого waste'а), ADR-0014 (agent-flow issue closure contract), ADR-AF-0026 (recovery contract — worker отвечает за следствие), `t_e00f448d` (PR #1743 — diagnostic-классификация), `t_9d375e3e` (ретро, родитель этой карточки). |
