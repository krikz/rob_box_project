...
| Родители | ADR-0014 (честный PASS/FAIL), ADR-0018 (честность), ADR-AF-0026 (recovery contract), ADR-0036 §4.2 (cron-надзор и watchdog runtime-overshoot), ADR-0042 (unknown-assignee rollup — пример cron-надзора для board-шумов). |
