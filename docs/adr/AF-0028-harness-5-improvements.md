# ADR-AF-0028: Пять улучшений harness — subagent-review, контекст от Шифу, домен-маппинг, декомпозиция, DRY
...
- **ADR-0027 (отменён)** — wip-черновик в ветке
  ...
  develop. Этот ADR-AF-0028 — пересмотренная и актуальная версия с учётом
...
включает browser-e2e (отменённый Шифу приоритет). Этот ADR-AF-0028 —
