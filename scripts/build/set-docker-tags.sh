...
if [ -f "$ENV_FILE" ]; then
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "Будут использоваться образы с тегом: -lyrical-${IMAGE_TAG}"
    echo ""
    echo "Примеры:"
    echo "  - ghcr.io/krikz/rob_box:voice-assistant-lyrical-${IMAGE_TAG}"
    echo "  - ghcr.io/krikz/rob_box:oak-d-lyrical-${IMAGE_TAG}"
    echo "  - ghcr.io/krikz/rob_box:rtabmap-lyrical-${IMAGE_TAG}"
    echo ""
