...
Будут использоваться образы с тегом: -lyrical-dev

Примеры:
  - ghcr.io/krikz/rob_box:voice-assistant-lyrical-dev
  - ghcr.io/krikz/rob_box:oak-d-lyrical-dev
  - ghcr.io/krikz/rob_box:rtabmap-lyrical-dev
```
...
# ROS дистрибутив (по умолчанию: lyrical)
...
Образ: ghcr.io/krikz/rob_box:voice-assistant-lyrical-local

[build output...]

✅ Успешно собран: ghcr.io/krikz/rob_box:voice-assistant-lyrical-local
```
...
#    - Соберёт образ с тегом -lyrical-test
#    - Запустит тесты
...
```
docker-compose pull
ERROR: pull access denied for ghcr.io/krikz/rob_box:voice-assistant-lyrical-wrong
```
