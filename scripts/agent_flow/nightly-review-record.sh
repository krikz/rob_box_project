...
# ревью (ADR-0116, follow-up ADR-0049, issue #2159).
#
...
# Первая версия ADR-0116 пыталась решить это, читая переменную
...
#
# РЕШЕНИЕ: тот же паттерн, что ADR-0115 использует для обычных worker-
...
# `partialFingerprints`, см. docs/adr/0116-nightly-review-persistence.md).
#
# ЧТО ДЕЛАЕТ:
...
#
# ЧЕГО НЕ ДЕЛАЕТ:
#   - НЕ коммитит и НЕ пушит файл — как kanban-report-write.sh (ADR-0115),
