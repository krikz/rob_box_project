...
/g')"
    ...
    if printf '%s' "$body_lower" | grep -q '## e2e'; then
        ...
        e2e_voice_text="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*voice_text[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*voice_text[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_voice_file="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*voice_file[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*voice_file[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_volume="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*volume[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*volume[[:space:]]*:[[:space:]]*//; s/[[:space:]]*$//' || true)"
        e2e_record_seconds="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*record_seconds[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*record_seconds[[:space:]]*:[[:space:]]*//; s/[[:space:]]*$//' || true)"
        e2e_llm="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*llm[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*llm[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_tts="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*tts[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*tts[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_stt="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*stt[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*stt[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_acceptance_check="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*acceptance_check[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*acceptance_check[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
        e2e_check_tg_echo="$(printf '%s' "$body_real" | grep -iE '^[[:space:]]*check_tg_echo[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*check_tg_echo[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
    ...
    if [ -z "$e2e_voice_text" ] && [ -z "$e2e_voice_file" ] && [ -n "$pr_number" ]; then
        ...
        if [ -n "$pr_body" ]; then
            ...
            if printf '%s' "$pr_body_lower" | grep -q '## e2e'; then
                e2e_voice_text="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*voice_text[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*voice_text[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
                e2e_voice_file="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*voice_file[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*voice_file[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
                e2e_volume="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*volume[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*volume[[:space:]]*:[[:space:]]*//; s/[[:space:]]*$//' || true)"
                e2e_record_seconds="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*record_seconds[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*record_seconds[[:space:]]*:[[:space:]]*//; s/[[:space:]]*$//' || true)"
                e2e_llm="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*llm[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*llm[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
                e2e_tts="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*tts[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*tts[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
                e2e_stt="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*stt[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*stt[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
                e2e_acceptance_check="$(printf '%s' "$pr_body_real" | grep -iE '^[[:space:]]*acceptance_check[[:space:]]*:' | head -1 | sed -E 's/^[[:space:]]*acceptance_check[[:space:]]*:[[:space:]]*//; s/^"//; s/[[:space:]]*$//; s/"$//' || true)"
