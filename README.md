...
- **[Быстрый старт](docs/getting-started/QUICK_START_RU.md)** - Запуск системы за 10 минут
- **[Чеклист](docs/getting-started/CHECKLIST.md)** - Контрольный список запуска
...
- **[Скрипты мониторинга](docs/guides/POWER_MONITORING_SCRIPTS.md)** - Проверка состояния системы
...
- **[Bash алиасы](docs/guides/BASH_ALIASES.md)** - Удобные команды

### 📖 Справочная информация
- **[Архитектура](docs/reference/ARCHITECTURE.md)** - Полная архитектура системы
- **[Конфигурация RTAB-Map + LiDAR](docs/reference/RTABMAP_LIDAR_CONFIG.md)** ⭐ - 2D SLAM с лазерным сканером
- **[Fusion 360 Measurements](docs/reference/FUSION360_MEASUREMENTS.md)** - Геометрия робота
- **[VESC Integration](docs/reference/VESC_INTEGRATION.md)** - Интеграция моторов
- **[Оптимизация](docs/reference/OPTIMIZATION.md)** - Детали оптимизации OAK-D + RTAB-Map
- **[Резюме оптимизации](docs/reference/OPTIMIZATION_SUMMARY.md)** - Краткий обзор изменений
