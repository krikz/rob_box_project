...
| SL-2 | Один Zenoh router = SPOF | docker/main/zenoh-router/ | medium | addressed:M2 | Redundancy отложена (lab); добавлены Prometheus alert rules (ADR-0017, PR #1271): ZenohRouterMainDown/VisionDown |
